namespace test_patcher
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
			...
			this.label1.Text = "Select ISO image:";
			// 
			// label2
			// 
			...
			this.label2.Text = "Place ISO keys here:";
			// 
			// richTextBox1
			// 
			...
			this.button3.Location = new System.Drawing.Point(181, 78);
			...
			this.label3.Text = "Select IRD image:";
			// 
			// Form1
			// 
